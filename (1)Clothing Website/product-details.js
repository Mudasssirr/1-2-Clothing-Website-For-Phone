...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (product) {
        ...
        <p class='SKU-number'>SKU#: ${product.name}</p>
        <p class='product-colour'>Color: <span class='light-font'> ${product.colour} </span></p>
        <p class='product-cut'>Cut: <span class='light-font'> Basic </span></p>
        <p class='product-dupatta'>Dupatta: <span class='light-font'> Included </span></p>
        <p class='product-trousers'>Trousers: <span class='light-font'> Included </span></p>
        </div>
...
// smallSize && smallSize.addEventListener('click', defineSize)